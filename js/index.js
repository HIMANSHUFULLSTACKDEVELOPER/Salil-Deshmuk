...
function initScrollAnimations() {
    ...
    document.querySelectorAll('.nit-container, .nit-badge-section, .nit-vision-section, .nit-footer, .ib-header, .ib-courses-grid, .nitsectionn, .niit-stats, .niit-section-title .niit-section-sub, .niit-facility-grid, .niit-photo-box, .niit-bottom, .niit-hero, .niit-section-title, .niit-section-sub, .niit-tour-btn, .niit-cta ,.news-section').forEach(el => {
